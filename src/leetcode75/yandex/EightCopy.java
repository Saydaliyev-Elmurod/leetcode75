  ...
  public static void main(String[] args) throws IOException {
    ...
    while (m-- > 0) {
      ...
      List<Integer> indexes =
          strMap.computeIfAbsent(item, s -> new LinkedList<>());
      indexes.add(index);
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (strMap.containsKey(temp.toString())) {
        List<Integer> indexes = strMap.get(temp.toString());
        res.append(" ").append(indexes.getFirst());
